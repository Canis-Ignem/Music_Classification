...
n_D_hidden_outputs2 = 1024
n_G_hidden_outputs2 = 1024
...
D_W2 = tf.Variable(xavier_init([n_D_hidden_outputs, n_D_hidden_outputs2]))
D_b2 = tf.Variable(xavier_init([n_D_hidden_outputs2]))

D_W3 = tf.Variable(xavier_init([n_D_hidden_outputs2, 1]))
D_b3 = tf.Variable(xavier_init([1]))

theta_D = [D_W1,D_W2,D_b1, D_b2, D_b3, D_W3 ]
...
G_W2 = tf.Variable(xavier_init([n_D_hidden_outputs, n_G_hidden_outputs2]))
G_b2 = tf.Variable(xavier_init([n_G_hidden_outputs2]))

G_W3 = tf.Variable(xavier_init([n_G_hidden_outputs2, n_inputs]))
G_b3 = tf.Variable(tf.zeros(shape=[n_inputs]))

theta_G = [G_W1, G_W2, G_b1, G_b2, G_b3, G_W3]
...
def generator(z):
    ...
    G_h2 = tf.nn.relu(tf.matmul(G_h1,D_W2) + D_b2)
